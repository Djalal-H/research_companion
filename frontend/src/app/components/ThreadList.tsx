...
const STATUS_COLORS: Record<ThreadItem["status"], string> = {
  ...
  busy: "bg-primary",
  interrupted: "bg-[var(--color-warning)]",
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center">
      ...
      <p className="mt-1 max-w-48 text-xs leading-5 text-muted-foreground">
        Start a conversation to build your research history.
      </p>
    </div>
  );
}
...
export function ThreadList({
  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      <div className="grid flex-shrink-0 grid-cols-[1fr_auto] items-center gap-3 border-b border-border bg-card/70 p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <SelectTrigger
              className="h-8 w-fit bg-background text-xs"
                  ...
                  <div className="flex flex-col gap-1">
                    {groupThreads.map((thread) => (
                      <button
                        ...
                        className={cn(
                          "grid w-full cursor-pointer items-center gap-3 rounded-xl px-3 py-3 text-left transition-colors duration-200 hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring",
