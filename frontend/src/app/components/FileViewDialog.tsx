...
export const FileViewDialog = React.memo<{
  ...
  const handleCopy = useCallback(() => {
    if (fileContent) {
      navigator.clipboard
        ...
        .then(() => toast.success("File contents copied"))
  ...
  return (
    ...
    >
      <DialogContent className="flex h-[min(80dvh,760px)] max-h-[calc(100dvh-2rem)] min-w-0 flex-col p-4 sm:min-w-[60vw] sm:p-6">
        ...
        <div className="min-h-0 flex-1 overflow-hidden">
          {isEditingMode ? (
            ...
            <ScrollArea className="h-full rounded-xl border border-border bg-muted/20">
              <div className="p-4">
                {fileContent ? (
                  isMarkdown ? (
