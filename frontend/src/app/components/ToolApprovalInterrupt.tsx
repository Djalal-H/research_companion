...
export function ToolApprovalInterrupt({
  ...
  return (
    <section
      className="w-full rounded-xl border border-amber-500/30 bg-amber-500/5 p-4"
      role="alert"
      ...
      <div className="mb-4 rounded-lg border border-border bg-background p-3">
        ...
        {isEditing ? (
          ...
          <div>
            ...
            <pre className="mt-2 overflow-x-auto whitespace-pre-wrap break-all rounded-md border border-border bg-muted/40 p-3 font-mono text-xs leading-5 text-foreground">
        ...
        {isEditing ? (
          <>
            ...
            <Button
              ...
              onClick={handleEdit}
              disabled={isLoading}
              className="bg-[var(--color-success)] text-white hover:brightness-95"
            >
              <Check size={14} />
